...
//This Plugin is used for exporting a CSV file with all selected Links for labelling your cables
//The Printer which was used was a Brother PTouch and the Printing suite by Brother
//In Order to use this Plugin you need a modified base Racktables.
//Normally, this File should've been distributed with all modified files, but if you got it without these,
//please go to https://github.com/UristMcMiner/racktables-Collection and get the Package.
//A wiki page for this Exporter should be available on the GitHub repository, but only in German.
//Written by Florian Baier
//07.07.2014
//Please do not remove this Information if you alter this file
//
//Important: You need to fill in some Information before using:
//L105: Fill in the hostname of your Racktables Machine 
//L135: Fill in the Link to a wiki page, or comment it out if you do not wish to use it
...
<tr>
<td>
<form action="http://<!---PUT HOSTNAME OF YOUR RACKTABLES HERE--->/index.php?page=rackspace&tab=LabelExport" method="post">
...
<div align="left">
<br>
<a href="<!---PUT LINK TO MANUAL HERE--->" target="_blank">Anleitung zur Benutzung</a>
</div>
</div>
